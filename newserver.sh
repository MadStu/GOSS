...
useradd -m -s /bin/bash gossuser
echo "gossuser:$PASS" | chpasswd
usermod -aG sudo gossuser
...
echo "              reboot"
echo " "
echo " Then log back in with your new gossuser account to complete the installation."
echo " "
